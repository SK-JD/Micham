import { ApiError, beginRequest, handleError, jsonOk, method, type ApiRequest, type ApiResponse } from "../../_lib/http.js";
  ...
  try {
    ...
    try {
      ...
      if (!delivery.delivered) {
        throw new ApiError(502, "Export email could not be sent. Check mail settings and try again.", "EMAIL_DELIVERY_FAILED", true);
      }
